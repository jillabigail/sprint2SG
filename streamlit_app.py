...
model = pickle.load(open('/content/drive/MyDrive/my_workspace/Week 3 Notebooks/Sprint Output/Dropout Rate/gb_sm.pkl', 'rb'))
X_holdout = pd.read_csv('/content/drive/MyDrive/my_workspace/Week 3 Notebooks/Sprint Output/Dropout Rate/holdout.csv', index_col=0)
